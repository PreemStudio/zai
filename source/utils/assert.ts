...
export const assert: Assert = {
	...
	bytes: (value: unknown): asserts value is Uint8Array => assertType(value instanceof Uint8Array, 'bytes'),
	defined: <T>(value: unknown): asserts value is NonNullable<T> =>
		assertType(
	...
	object: (value: unknown): asserts value is Record<string, unknown> => assertType(typeof value === 'object', 'object'),
